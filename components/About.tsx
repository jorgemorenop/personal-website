...
export default function About() {
    return (
        <PageSection sectionName="About me" sectionId="about">
            ...
            />
            <p>
                I'm an freelance software engineer from Spain. I've mostly worked as Data Engineer with a deeply use
                of Cloud environments (mostly AWS). I have also prior experience as Data Scientist. I consider
                myself an easy-going person, and I like a lot to help my co-workers in everything I can (if I can,
                of course). I enjoy learning new stuff and I also like to think that I’m quite good analyzing and
                solving problems.
